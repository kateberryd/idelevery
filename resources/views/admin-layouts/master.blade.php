...
<head>
    ...
    <title>Add Products | iDelivery</title>
    ...
    <link rel="stylesheet" href="/dashboard/css/data-table/bootstrap-table.css">
    <link rel="stylesheet" href="/dashboard/css/data-table/bootstrap-editable.css">
    ...
    <!-- maskedinput JS
		============================================ -->
    <script src="/dashboard/js/jquery.maskedinput.min.js"></script>
    <script src="/dashboard/js/masking-active.js"></script>
    <!-- datepicker JS
		============================================ -->
    <script src="/dashboard/js/datepicker/jquery-ui.min.js"></script>
    <script src="/dashboard/js/datepicker/datepicker-active.js"></script>
    <!-- form validate JS
		============================================ -->
    <script src="/dashboard/js/form-validation/jquery.form.min.js"></script>
    <script src="/dashboard/js/form-validation/jquery.validate.min.js"></script>
    <script src="/dashboard/js/form-validation/form-active.js"></script>
    <!-- dropzone JS
		============================================ -->
